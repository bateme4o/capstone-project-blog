import{r as e,i as s}from"./layout-BCOD6sox.js";const a=document.querySelector("#app"),t=e(a,{title:"About",activePage:"about"});t.innerHTML=`
  ...
  <section class="row g-4">
    ...
    <div class="col-md-4">
      <div class="feature-panel rounded-4 p-4 border h-100">
        ...
        <p class="text-secondary mb-0">${s?"Supabase is connected.":"Demo mode is active until the environment variables are set."}</p>
      </div>
    </div>
  </section>
`;
