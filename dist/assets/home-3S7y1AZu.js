import{r as i,a as o}from"./layout-BCOD6sox.js";import{r}from"./post-card-DzSWXvM_.js";import{l}from"./posts-service-z_18iu8_.js";import"./content-CeYgp_3t.js";const t=document.querySelector("#app"),d=i(t,{title:"Home",activePage:"home"});d.innerHTML=`
...
`;const s=t.querySelector("[data-featured-posts]");async function n(){try{const e=await l({limit:3});if(!e.length){s.innerHTML=`
        <div class="col-12">
      ...
      `).join("")}catch(e){s.innerHTML=`
      <div class="col-12">
        <div class="alert alert-danger border-0">Unable to load posts: ${e.message}</div>
      </div>
    `}}n();document.title=`${o} | Home`;
